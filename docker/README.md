...
don't need their own folder, and will just be entirely defined in the compose stack. The `compose.yaml` should stay in this folder, and `up.sh` in the repo root should "just work"
